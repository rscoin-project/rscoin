...
Provides utilities for managing copyright headers of `The RSCOIN
...
---------------------------------------------------------
Updates all the copyright headers of `The RSCOIN developers` which were
changed in a year more recent than is listed. For example:
```
// Copyright (c) <firstYear>-<lastYear> The RSCOIN developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The RSCOIN developers
```
...
those cases:
```
// Copyright (c) <year> The RSCOIN developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The RSCOIN developers
```
where the update is appropriate.

copyright\_header.py insert \<file\>
------------------------------------
Inserts a copyright header for `The RSCOIN developers` at the top of the
...
If the file already has a copyright for `The RSCOIN developers`, the
script will exit.
...
RSCOIN-Project/RSCOIN repository.
...
Setup
---------
Configuring the github-merge tool for the RSCOIN repository is done in the following way:

    git config githubmerge.repository RSCOIN-Project/RSCOIN
...
A script to optimize png files in the RSCOIN
