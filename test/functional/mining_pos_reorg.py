...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected RSCOIN and zRSCOIN supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check RSCOIN and zRSCOIN supply at the beginning
        # ------------------------------------------
        # zRSCOIN supply: 2 coins for each denomination
        ...
        # RSCOIN supply: block rewards minus burned fees for minting
        ...
        # Verify that RSCOIN and zRSCOIN supplies were properly updated after the spends and reorgs
        self.log.info("Check RSCOIN and zRSCOIN supply...")
