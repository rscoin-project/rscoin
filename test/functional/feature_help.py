...
"""Verify that starting rscoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rscoin with -h for help text")
        ...
        self.log.info("Start rscoin with -version for version information")
