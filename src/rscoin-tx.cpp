...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RSCOIN Core rscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rscoin transaction") + "\n" +
                               "  rscoin-tx [options] -create [commands]   " + _("Create hex-encoded rscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rscoin transaction
