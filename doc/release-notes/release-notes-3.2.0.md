...
A full report provided by RSCOIN developers is available on the [RSCOIN Website](https://rscoin.org/fake-stake-official-rscoin-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://rscoin.org/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
