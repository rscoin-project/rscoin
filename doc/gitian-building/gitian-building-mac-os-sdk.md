...
The script [extract-osx-sdk.sh](https://github.com/rscoin-project/rscoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
rscoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/rscoin-project/rscoin/blob/master/doc/README_osx.md) for troubleshooting tips.